...
// クラスタに参加するノードの単位をagentとする。
// サーバー機能を担うserver、クラスタ参加機能を担うmembership、クラスタのログを複製するreplicator、ローカルにログを仕込むlogを所持
// chapter8で変更、単純なreplicatorによる複製でなく、リーダー選出アルゴリズムraftを用いた分散ログを代わりに使用
