...
// 実態は、ログの複製。
// 合意形成アルゴリズムにより、リーダーを選出。クラスタへのほかの参加者はフォロワーとなる。
// リーダーは、フォロワーのログの複製を行う。この複製は、gRPCによって行う
...
// raftを立ち上げる
// raftは、サーバーの状態や投票結果など、メタデータを保持する
...
func (s *StreamLayer) Dial(
	...
	// Raft RPCであることを特定するため、パケットに情報を追加。
	// これにより、一つのコネクションで、gRPCもRaftも使えるようになる。
